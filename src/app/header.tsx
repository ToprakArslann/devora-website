        ...
        <div className="fixed w-full top-0 z-15 mt-5 px-5 mix-blend-difference">
            <div className={`w-full flex flex-row rounded-full justify-between ${satoshi.className}`}>
                ...
                <div className="flex flex-row gap-5 items-center">
                   <a className="text-2xl text-white hover:underline hover:bg-white hover:text-black py-1 px-2" href="">About Us</a>
                   <a className="text-2xl text-white hover:underline hover:bg-white hover:text-black py-1 px-2" href="">Services</a>
                   <a className="text-2xl text-white hover:underline hover:bg-white hover:text-black py-1 px-2" href="">References</a>
